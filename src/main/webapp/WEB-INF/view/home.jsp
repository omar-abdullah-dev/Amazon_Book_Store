            ...
            <div class="col-lg-8">
                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    <a href="${pageContext.request.contextPath}/book/list" class="btn btn-amazon btn-lg px-4 shadow-sm">
                        <i class="bi bi-journal-richtext me-2"></i> Browse Books
                    </a>
                    <a href="${pageContext.request.contextPath}/category/list" class="btn btn-outline-primary btn-lg px-4 fw-semibold">
                        <i class="bi bi-tags me-2"></i> Categories
                    </a>
                    <a href="${pageContext.request.contextPath}/author/list" class="btn btn-outline-secondary btn-lg px-4 fw-semibold">
                ...
                <div class="card border-0 shadow-sm rounded-3 h-100 p-3">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="fw-bold mb-0">${empty totalBooks ? 0 : totalBooks}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 h-100 p-3">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="fw-bold mb-0">${empty totalCategories ? 0 : totalCategories}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 h-100 p-3">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="fw-bold mb-0">${empty totalAuthors ? 0 : totalAuthors}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 h-100 p-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <i class="bi bi-collection fs-3 text-warning me-2"></i>
                            <h5 class="fw-bold m-0">Book Inventory</h5>
                        </div>
                        <p class="text-secondary mb-4">
                            Explore catalog with category links, authors, and full publication details.
                        </p>
                        <a href="${pageContext.request.contextPath}/book/list" class="btn btn-amazon fw-semibold shadow-sm">
                            Open Catalog <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm rounded-3 h-100 p-4">
                    <div class="card-body">
                        ...
                        <p class="text-secondary mb-4">
                            Organize book catalog by genres and subject classifications.
                        </p>
                        <a href="${pageContext.request.contextPath}/category/list" class="btn btn-outline-primary fw-semibold">
                            View Categories <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 h-100 p-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="fw-bold m-0">Authors</h5>
                        </div>
                        <p class="text-secondary mb-4">
                            Manage author profiles and contributor mappings.
                        </p>
                        <a href="${pageContext.request.contextPath}/author/list" class="btn btn-outline-secondary fw-semibold">
                            View Authors <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
            </div>
