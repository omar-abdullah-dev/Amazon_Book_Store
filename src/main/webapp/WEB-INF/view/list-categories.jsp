...
<div class="container my-5">
    ...
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            <h2 class="fw-bold m-0"><i class="bi bi-tags text-primary me-2"></i>Category Inventory</h2>
            <p class="text-secondary mb-0">Manage book categories and genres</p>
        </div>
    ...
    <div class="card shadow-sm border-0 mb-4 rounded-3">
        <div class="card-body p-3">
            <div class="input-group">
                ...
                <input type="text" id="categorySearchInput" class="form-control border-start-0" 
                       placeholder="Search category by name or ID in real-time..." onkeyup="filterCategories()" />
            </div>
        </div>
    </div>
                            ...
                            <tr class="category-row">
                                ...
                                <td>
                                    <span class="badge badge-category px-3 py-2 fs-6 category-name">
                                        <i class="bi bi-tag me-1"></i>${tempCategory.name}
                                    </span>
                                </td>
                                <td class="text-end pe-4">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-danger py-1 px-3"
                                                onclick="openDeleteModal('${deleteLink}', '${tempCategory.name}')">
